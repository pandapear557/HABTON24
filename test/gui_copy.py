...
class MyApp:
    def __init__(self, root, chatbot_instance):
        ...
        self.font=tkinter.font.Font(family="NeoDunggeunmo Code", size=24)
        ...
        self.canvas.create_window(35,550,window=self.entry,width=850,height=70,anchor=tk.SW)
    ...
    def process_input(self, event):
        ...
        if user_input:
            ...
            typing_instance = type_md.TypeHangul(self.label, response, delay=20)
